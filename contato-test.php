                ...
                <div class="textos clearfix">
                    ...
                    <div class="formulario">
                        ...
                        <form class="clearfix" id="ajax-contact" method="post" action="mailer.php">
                            ...
                            <input class="campo" type="text" name="email" id="email" placeholder="E-mail" required/></p>
                            ...
                            <div class="form_serv active">
                                ...
                                <label for="details">Descrever no quadro abaixo detalhes dos serviços a serem executados:</label>
                                <textarea name="details" id="details"></textarea>

                                <label for="duvidas">Coloque suas dúvidas neste quadro:</label>
